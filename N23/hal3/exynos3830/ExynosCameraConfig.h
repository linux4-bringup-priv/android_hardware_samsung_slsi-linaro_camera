...
#define SUPPORT_LIMITED_HW_LEVEL_FALSH
...
#define SUPPORT_VIRTUALFD_PREVIEW
...
#define USE_SW_MCSC                     (true)
#define USE_SW_MCSC_REPROCESSING        (false)
...
#define USE_RESERVED_NODE_PPJPEG_MCSCPORT    (false)
...
#define NUM_OF_MCSC_OUTPUT_PORTS            (1)

#define NUM_OF_M2M_MCSC_OUTPUT_PORTS            (1)
...
/* MCSC - CLAHE */
#define MAIN_CAMERA_SINGLE_MCSC_CLAHE_OTF   (HW_CONNECTION_MODE_NONE)
#define FRONT_CAMERA_SINGLE_MCSC_CLAHE_OTF  (HW_CONNECTION_MODE_NONE)
#define MAIN_CAMERA_PIP_MCSC_CLAHE_OTF      (HW_CONNECTION_MODE_NONE)
#define FRONT_CAMERA_PIP_MCSC_CLAHE_OTF     (HW_CONNECTION_MODE_NONE)
...
/* ISP - MCSC */
#define MAIN_CAMERA_SINGLE_ISP_MCSC_OTF_REPROCESSING    (HW_CONNECTION_MODE_M2M)
#define FRONT_CAMERA_SINGLE_ISP_MCSC_OTF_REPROCESSING   (HW_CONNECTION_MODE_M2M)
#define MAIN_CAMERA_PIP_ISP_MCSC_OTF_REPROCESSING       (HW_CONNECTION_MODE_M2M)
#define FRONT_CAMERA_PIP_ISP_MCSC_OTF_REPROCESSING      (HW_CONNECTION_MODE_M2M)
#ifdef USE_DUAL_CAMERA
#define MAIN_CAMERA_DUAL_ISP_MCSC_OTF_REPROCESSING      (HW_CONNECTION_MODE_M2M)
#define FRONT_CAMERA_DUAL_ISP_MCSC_OTF_REPROCESSING     (HW_CONNECTION_MODE_M2M)
#define SUB_CAMERA_DUAL_ISP_MCSC_OTF_REPROCESSING       (HW_CONNECTION_MODE_M2M)
#endif
...
/* MCSC - CLAHE */
#define MAIN_CAMERA_SINGLE_MCSC_CLAHE_OTF_REPROCESSING    (HW_CONNECTION_MODE_NONE)
#define FRONT_CAMERA_SINGLE_MCSC_CLAHE_OTF_REPROCESSING   (HW_CONNECTION_MODE_NONE)
#define MAIN_CAMERA_PIP_MCSC_CLAHE_OTF_REPROCESSING       (HW_CONNECTION_MODE_NONE)
#define FRONT_CAMERA_PIP_MCSC_CLAHE_OTF_REPROCESSING      (HW_CONNECTION_MODE_NONE)
...
#define SUPPORT_8M_LINE_BUFFER_SIZE /* post ISP max size is 8M */
#ifdef CAMERA_PACKED_BAYER_ENABLE
#define CAMERA_FLITE_BAYER_FORMAT               (V4L2_PIX_FMT_SBGGR12)

#define CAMERA_3AC_BAYER_FORMAT                 (V4L2_PIX_FMT_SBGGR8)
#define CAMERA_3AP_BAYER_FORMAT                 (V4L2_PIX_FMT_SBGGR8)
