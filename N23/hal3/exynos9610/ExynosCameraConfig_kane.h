...
#define ANDROIDQ_CAM_SERVICE_BUF_WA
...
#define SUPPORT_VENDOR_DYNAMIC_SENSORMODE_BY_SESSION_PARAMETER_ALWAYS_BAYER
#endif
...
#define SUPPORT_FACTORY_CHECK_ACTIVE_CAMERA
...
#define LITTLE_CORE_MIN_LOCK_SW_REMOSAIC_CAPTURE    cpu_clk_lock(0, 403)
#endif

#ifdef SUPPORT_CPU_BOOST_VDIS_RECORDING_MODE
#define BIG_CORE_MAX_LOCK_UHD30_VDIS_RECORDING    cpu_clk_lock(0, 1456)
#define LITTLE_CORE_MIN_LOCK_UHD30_VDIS_RECORDING cpu_clk_lock(0, 403)
#define BIG_CORE_MAX_LOCK_FHD60_VDIS_RECORDING    cpu_clk_lock(0, 1508)
#define LITTLE_CORE_MIN_LOCK_FHD60_VDIS_RECORDING cpu_clk_lock(0, 403)
#endif
...
#define DUMP_SERIAL_NUMBER_SIZE 16
#define DUMP_SERIAL_NUMBER_OFFSET 137
#else
...
/********************************
 * SUPPORT REMAP SERVICE_ID     *
 ********************************/
#define SUPPORT_REMAP_CAMERA_SERVIDE_ID
#ifdef SUPPORT_REMAP_CAMERA_SERVIDE_ID
#define REMAP_CAMERA_SERVICE_ID_REAR_2ND    (2)
#define REMAP_CAMERA_SERVICE_ID_FRONT_2ND   (51)
#define REMAP_CAMERA_SERVICE_ID_REAR_3RD    (52)
#define REMAP_CAMERA_SERVICE_ID_FRONT_3RD   (53)
#define REMAP_CAMERA_SERVICE_ID_REAR_4TH    (54)
#define REMAP_CAMERA_SERVICE_ID_FRONT_4TH   (55)
#define REMAP_CAMERA_SERVICE_ID_REAR_TOF    (80)
#define REMAP_CAMERA_SERVICE_ID_FRONT_TOF   (81)
#define REMAP_CAMERA_SERVICE_ID_IRIS        (90)
#endif
...
#define MULTI_REAR_CAMERA_MAIN_RATIO    (1.0f)
#define MULTI_REAR_CAMERA_SUB_RATIO     (2.0f)
#define MULTI_REAR_CAMERA_SUB2_RATIO    (0.5f)
#endif
...
#define CAMERA_SERVICE_ID_DUAL_REAR_PORTRAIT_TELE_MAIN  (CAMERA_ID_BACK_2)
#define CAMERA_SERVICE_ID_DUAL_REAR_PORTRAIT_TELE_SUB   (CAMERA_ID_BACK)
#endif
...
#define TORCH_REAR_FILE_PATH_1 "/sys/class/leds/fled-s2mu106/fled_mode"
#define TORCH_REAR_CURRENT_PATH_1 "/sys/class/leds/fled-s2mu106/fled_torch_curr"
...
//#define USE_AF_FOV_COMPENSATION
...
#define MAIN_CAMERA_PIP_3AA_VRA_OTF         (HW_CONNECTION_MODE_NONE)
#define FRONT_CAMERA_PIP_3AA_VRA_OTF         (HW_CONNECTION_MODE_NONE)
...
#define MAIN_CAMERA_DUAL_ISP_DCP_OTF_REPROCESSING       (HW_CONNECTION_MODE_M2M)
#define FRONT_CAMERA_DUAL_ISP_DCP_OTF_REPROCESSING      (HW_CONNECTION_MODE_VIRTUAL_OTF)
...
#define MAIN_CAMERA_DUAL_DCP_MCSC_OTF_REPROCESSING      (HW_CONNECTION_MODE_M2M)
#define FRONT_CAMERA_DUAL_DCP_MCSC_OTF_REPROCESSING     (HW_CONNECTION_MODE_OTF)
...
#define MAIN_CAMERA_PIP_MCSC_VRA_OTF_REPROCESSING       (HW_CONNECTION_MODE_M2M)
#define FRONT_CAMERA_PIP_MCSC_VRA_OTF_REPROCESSING      (HW_CONNECTION_MODE_M2M)
/* 3AA - VRA */
...
#define FRONT_CAMERA_3AA_NUM            FIMC_IS_VIDEO_31S_NUM
...
#define FPS120_NUM_REQUEST_VIDEO_BUFFER         (NUM_REQUEST_VIDEO_BUFFER * 4)
...
#else
#define FPS120_PIPE_FLITE_PREPARE_COUNT         (PIPE_FLITE_PREPARE_COUNT * 2)
#define FPS120_PIPE_3AA_PREPARE_COUNT           (PIPE_3AA_PREPARE_COUNT * 2)
#endif
...
#define CAMERA_3AF_OUTPUT_FORMAT        (V4L2_PIX_FMT_NV16)
