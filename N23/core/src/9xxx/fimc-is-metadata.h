...
#if defined(USE_CAMERA_EXYNOS9820_META)
#include "fimc-is-metadata_exynos9820.h"
#elif defined(USE_CAMERA_EXYNOS9630_META)
#include "fimc-is-metadata_exynos9630.h"
#elif defined(USE_CAMERA_EXYNOS3830_META)
#include "fimc-is-metadata_exynos3830.h"
#elif defined(USE_CAMERA_EXYNOS850_META)
#include "fimc-is-metadata_exynos850.h"
#else
...
#define DDK_VER_MAGIC_NUMBER_0  0xF85A20B4
#define DDK_VER_MAGIC_NUMBER_1  0xCA539ADF
...
enum is_subscenario_id {
    ...
    ISS_SUB_SCENARIO_STILL_CAPTURE_SUPER_RESOLUTION = 59,
    ISS_SUB_SCENARIO_STILL_CAPTURE_SUPER_NIGHT_SHOT = 60,
    ISS_SUB_SCENARIO_STILL_CAPTURE_LLHDR = 61,
    ISS_SUB_SCENARIO_STILL_CAPTURE_FLASH_MFDN = 62,
...
enum aa_capture_intent {
    ...
    /* vendor feature */
    AA_CAPTURE_INTENT_STILL_CAPTURE_OIS_SINGLE = 100, // 100
    ...
    AA_CAPTURE_INTENT_STILL_CAPTURE_RAWDUMP = AA_CAPTURE_INTENT_STILL_CAPTURE_COMP_BYPASS, // 103 (duplicated)
    ...
    AA_CAPTURE_INTENT_STILL_CAPTURE_LLHDR_VEHDR_DYNAMIC_SHOT, // 116
    AA_CAPTURE_INTENT_STILL_CAPTURE_VENR_DYNAMIC_SHOT, // 117
    AA_CAPTURE_INTENT_STILL_CAPTURE_LLS_FLASH, // 118
    AA_CAPTURE_INTENT_STILL_CAPTURE_SPORT_MOTIONLEVEL0, // 119
    AA_CAPTURE_INTENT_STILL_CAPTURE_SPORT_MOTIONLEVEL1, // 120
    AA_CAPTURE_INTENT_STILL_CAPTURE_SPORT_MOTIONLEVEL2, // 121
};
...
struct camera2_uctl {
    ...
    uint32_t                        statsRoi[4]; //For awb stat
...
{
    uint32_t header1; // DDK_VER_MAGIC_NUMBER_0
    uint32_t header2; // DDK_VER_MAGIC_NUMBER_1
...
enum camera_pixel_size {
    ...
    CAMERA_PIXEL_SIZE_PACKED_12BIT_COMP,
};

enum camera_pixel_comp_info {
    NO_COMP = 0,
    COMP
};
...
#endif // USE_CAMERA_EXYNOS9820_META
