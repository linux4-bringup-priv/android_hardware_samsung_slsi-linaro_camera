...
enum aa_capture_intent {
    ...
    AA_CAPTURE_INTENT_PREVIEW = 1,
    AA_CAPTURE_INTENT_STILL_CAPTURE = 2,
    AA_CAPTURE_INTENT_VIDEO_RECORD = 3,
    AA_CAPTURE_INTENT_VIDEO_SNAPSHOT = 4,
    AA_CAPTURE_INTENT_ZERO_SHUTTER_LAG = 5,
    AA_CAPTURE_INTENT_MANUAL = 6,
    AA_CAPTURE_INTENT_MOTION_TRACKING = 7,
    ...
    AA_CAPTURE_INTENT_STILL_CAPTURE_SUPER_NIGHT_SHOT_HANDHELD_FAST = 120,
    AA_CAPTURE_INTENT_STILL_CAPTURE_SUPER_NIGHT_SHOT_TRIPOD_FAST = 121,
    ...
    AA_CAPTURE_INTENT_STILL_CAPTURE_SR_HDR = 137,
...
pixelsize : per-frame pixel size
 */
