...
#define EXYNOS_CAMERA_NODE_OUT()  CLOGD("OUT..m_nodeState[%d]", m_nodeState)
#else
...
enum EXYNOS_CAMERA_NODE_LOCATION{
    NODE_LOCATION_SRC= 0,
    NODE_LOCATION_DST
};
...
enum NODE_TYPE {
    ...
    OUTPUT_NODE_2,
    OUTPUT_NODE_3 = OUTPUT_NODE_2,
    OUTPUT_NODE_4 = OUTPUT_NODE_2,
    OUTPUT_NODE_5 = OUTPUT_NODE_2,
#else
    OUTPUT_NODE_2 = OUTPUT_NODE,
    OUTPUT_NODE_3 = OUTPUT_NODE,
    OUTPUT_NODE_4 = OUTPUT_NODE,
    OUTPUT_NODE_5 = OUTPUT_NODE,
#endif
    MAX_OUTPUT_NODE,
...
class ExynosCameraNode : public ExynosCameraObject {
public:
...
public:
    ...
    /* open Node */
    virtual status_t open(int videoNodeNum, int operationMode);
    /* close Node */
    ...
    /* get Jpeg Encoder */
    virtual status_t getInternalModule(void **module);
    /* get video Num */
    virtual int      getNodeNum(void);

    bool isDebugInfoPlaneNode(int *planeCount);

    /* set v4l2 color format */
    virtual status_t setColorFormat(int v4l2Colorformat, int planesCount,
